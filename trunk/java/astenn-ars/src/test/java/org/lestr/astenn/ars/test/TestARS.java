...
package org.lestr.astenn.ars.test;
...
import org.lestr.astenn.protocol.ars.ARSPluginsProvider;
...
public class TestARS extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        //PluginsManager.getSingleton().getConfiguration().getPluginsProviders().add(new ARSPluginsProvider());
        ...
        PluginsManager.getSingleton().registerPlugin(IPlugin.class, "ars:http://127.0.0.1:8078/" + IPlugin.class.getName() + "/" + Plugin.class.getName());
